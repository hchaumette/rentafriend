...
puts "create booking"
Booking.create!(user: user1, activity: activity3, state: "pending")
Booking.create!(user: user5, activity: activity1, state: "accepted")
Booking.create!(user: user4, activity: activity2, state: "declined")
Booking.create!(user: user2, activity: activity4, state: "accepted")
Booking.create!(user: user1, activity: activity5, state: "accepted")
