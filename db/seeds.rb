...
puts "create booking"
 booking1 = Booking.create!(user: user1, activity: activity3, state: "pending", start_date: "03/02/2023", end_date: "10/02/2023")
 ...
 booking4 = Booking.create!(user: user2, activity: activity4, state: "accepted", start_date: "19/12/2022", end_date: "10/01/2023")
 booking5 = Booking.create!(user: user1, activity: activity5, state: "accepted", start_date: "03/12/2022", end_date: "04/12/2022")
